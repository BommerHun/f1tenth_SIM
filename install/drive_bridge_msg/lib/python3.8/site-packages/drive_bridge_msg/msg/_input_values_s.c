...
bool drive_bridge_msg__msg__input_values__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("drive_bridge_msg.msg._input_values.InputValues", full_classname_dest, 46) == 0);
  }
  drive_bridge_msg__msg__InputValues * ros_message = _ros_message;
  {  // delta
...
PyObject * drive_bridge_msg__msg__input_values__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("drive_bridge_msg.msg._input_values");
