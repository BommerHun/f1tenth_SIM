...
static const _InputValues_type_support_symbol_names_t _InputValues_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drive_bridge_msg, msg, InputValues)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drive_bridge_msg, msg, InputValues)),
  }
};
...
{
  return &::drive_bridge_msg::msg::rosidl_typesupport_cpp::InputValues_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, drive_bridge_msg, msg, InputValues)() {
  return get_message_type_support_handle<drive_bridge_msg::msg::InputValues>();
}
